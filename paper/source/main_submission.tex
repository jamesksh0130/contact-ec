...
structures come from a shifted distribution, as observed on Price-149, which we
interpret as an OOD and coverage failure mode. Macro F1 remains low due to the
