...
nearly all evaluable temporal proteins, so the temporal results should not be
interpreted as fold-disjoint structural generalization. Macro F1 remains low due
to the long-tailed Level-4 label space.
