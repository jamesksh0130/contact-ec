...
retraining recovers +7.4\,pp on a matched encoder-evaluable subset, whereas
end-to-end ESM-2 fine-tuning reduces temporal micro F1 by 5.1\,pp. HIT-EC
remains stronger in absolute temporal performance
...
\midrule
Contact-EC-ExpA (recent data)$^\dagger$ & 0.7209 & 0.6578 & 0.5000 & 0.2764 \\
...
$0.6467\pm0.0210$ micro F1, whereas Contact-EC-ExpA reaches 0.7209. Thus the
fair-subset recent-corpus gain is +7.4\,pp, not the naive +11.8\,pp obtained by
...
rather than a pure date effect. In contrast,
...
for temporal robustness. The matched +7.4\,pp recent-corpus gain remains larger
