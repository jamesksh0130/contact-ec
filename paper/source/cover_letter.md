...
The manuscript is relevant to BMC Bioinformatics because it addresses benchmark reliability and reproducibility in machine-learning-based enzyme annotation, a central problem in sequence analysis and structural bioinformatics. To reduce ambiguity for reviewers, the revised submission explicitly reports temporal leakage checks, label-vocabulary coverage, Foldseek/TM-score-disjoint evaluation, three-seed repeats for the main temporal and fold-disjoint comparisons, calibration/error analyses, and public reproduction artifacts. Code, result tables, audit files, and manuscript figures are available at https://github.com/jamesksh0130/contact-ec.
